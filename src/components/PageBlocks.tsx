            ...
            >
              ...
              <div className="md:col-span-2 flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="px-4 py-3 bg-surface-container rounded-lg border border-border-subtle focus:outline-none focus:ring-2 focus:ring-primary resize-y"
              ...
              <div className="md:col-span-2 mt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-8 py-3 bg-primary hover:bg-primary-container text-white rounded-lg font-label-md text-label-md transition-colors w-full md:w-auto disabled:opacity-70"
                >
