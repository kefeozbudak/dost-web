...
const newGetAligned = `export const getAlignedCalendarDays = (blockMonth: string, originalDays: any[], monthOffset: number = 0) => {
...
code = code.replace(/export const getAlignedCalendarDays = \([\s\S]*?return alignedDays;\n\};/, newGetAligned);
